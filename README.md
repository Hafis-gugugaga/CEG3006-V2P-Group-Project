...
## Individual Reflection and Contributions

### Yejin – Use Case Design and Scenario Development
My main role was developing the use cases and real-world scenarios for the V2P system. Through this project, I realized V2P is not just a technical concept, but it is about creating a "safety buffer" before a dangerous interaction even starts. The real strength of the system is providing that early awareness in blind spots where a driver simply cannot see a pedestrian yet.
While mapping out the scenario of a pedestrian approaching a crossing, I had to ensure the communication flow was realistic and timely. It bridged the gap between my coursework on DSRC and V2X and actual road safety. I fully understand why low-latency messaging is so critical when you only have seconds to react. Ultimately, this taught me that engineering for safety is about enabling preventive action, rather than just reacting once a hazard becomes obvious.

### Gia Minh – System Concept and Functional Flow
I was responsible for mapping out the functional flow and core concept of the V2P system, focusing on how information moves from the pedestrian to the vehicle. Through this, I realized that a safety system is only as effective as its decision-making logic. The warning must be processed and delivered almost instantly to be useful. This project gave me hands-on exposure to communication protocols beyond the classroom, particularly how C-V2X utilizes the PC5 interface for low-latency safety messages. 
I began to appreciate that designing a functional flow involves much more than just sending a signal, but it is about ensuring that every interaction is both reliable and timely. Seeing these concepts in action made the distinction between direct PC5 communication and backend Uu interface functions much clearer. This experience really sharpened my ability to approach engineering problems from a high-level system perspective. Ultimately, it showed me how theoretical communication models translate into practical road safety solutions.

### Hessa – Focus on Vulnerable Pedestrians and User Needs
My role in this project was to contribute to the user-focused side of the V2P concept, especially in relation to vulnerable pedestrians. Through this, I developed a stronger understanding that V2P should not only be seen as a technical communication system, but also as a safety solution designed around people’s needs. This helped me understand why our V2P concept should place greater attention on vulnerable users instead of treating all pedestrians equally. 
It also made me realise that even when studying communication technologies such as C-V2X and PC5, the final purpose of these systems is still to improve safety for actual users. By focusing on user needs, I better understood that the success of a V2P system is not only measured by whether communication happens, but by whether that communication helps protect the people who need it most. This experience taught me that engineering design must always consider accessibility, inclusiveness, and human limitations. Overall, it helped me see V2P as a human-cantered transport safety solution rather than just a technical system.

### Hafis – Research and Understanding of V2P Systems
My main contribution was supporting the group’s understanding of V2P systems and how they can be applied to improve road safety. Through this, I learned that V2P refers to communication between vehicles and pedestrians in order to reduce the likelihood of collisions, especially in areas where visibility, timing, or reaction speed may be limited. I came to understand that traditional road safety measures often depend heavily on the driver being able to see and respond in time, while V2P adds an additional layer of awareness through direct communication. 
This made me appreciate how C-V2X can strengthen safety by making drivers aware of pedestrians earlier than they might through visual observation alone. The project also helped me connect what is taught in class to an actual engineering application, especially in understanding the difference between PC5 for direct communication and Uu for non-time-critical support functions. Through this research and understanding, I was able to contribute to the project by helping the group justify why such a system is necessary and beneficial. Overall, it gave me a much clearer understanding of why V2P is an important area of study and development.

### Kaelan – Practical Application and Safety Relevance
My main contribution was helping to connect the V2P concept to practical road safety applications. Through this role, I gained a better understanding that V2P is valuable because it can be applied in common traffic situations such as zebra crossings, pedestrian-heavy roads, and areas where drivers may have limited time to respond. I learned that the importance of V2P is not just in enabling communication, but in using that communication to support immediate and useful action from the driver. 
The project also helped me connect school topics to the vehicle side of the system, especially how a warning generated through C-V2X communication could be passed through the in-vehicle network using CAN bus to alert the driver. By linking the concept to real traffic situations, I was able to better appreciate how engineering solutions can be more impactful when they directly address everyday safety problems. Overall, I learned that the true value of V2P lies in its ability to translate communication into accident prevention.

### Kelly – Communication Flow and Driver Awareness in V2P
My contribution to this project was mainly in understanding how V2P communication can improve driver awareness in potential pedestrian conflict situations. Through working on the project, I learned that one of the main purposes of V2P is to provide an earlier warning to the driver before the pedestrian is fully noticed through normal visual observation. This helped me better understand that V2P is not just about connecting devices, but about improving reaction time and reducing the chances of accidents.
In our project, this made me appreciate the role of PC5 as the direct communication link for urgent safety warnings, while Uu supports less time-sensitive backend functions. It also helped me understand how CAN bus can be relevant on the vehicle side to deliver the warning to the dashboard or driver alert system. Overall, this experience helped me better understand how different communication layers work together to support safer and earlier driver response.
